...
func TestSessionCapabilities_Images(t *testing.T) {
	supported := newSessionCapabilities(conversation.NewProcessCapabilities(&acp.AgentCapabilities{PromptCapabilities: acp.PromptCapabilities{Image: true}}), nil, nil)
	...
	unsupported := newSessionCapabilities(conversation.NewProcessCapabilities(&acp.AgentCapabilities{}), nil, nil)
...
func TestSessionCapabilities_FilesAndPermissions_AlwaysSupported(t *testing.T) {
	caps := newSessionCapabilities(conversation.NewProcessCapabilities(&acp.AgentCapabilities{}), nil, nil)
...
func TestSessionCapabilities_ModelSelection(t *testing.T) {
	withModels := newSessionCapabilities(conversation.NewProcessCapabilities(&acp.AgentCapabilities{}), &conversation.SessionModelState{
	...
	noModels := newSessionCapabilities(conversation.NewProcessCapabilities(&acp.AgentCapabilities{}), &conversation.SessionModelState{}, nil)
	...
	nilModels := newSessionCapabilities(conversation.NewProcessCapabilities(&acp.AgentCapabilities{}), nil, nil)
...
func TestSessionCapabilities_ModeSelection(t *testing.T) {
	withModes := newSessionCapabilities(conversation.NewProcessCapabilities(&acp.AgentCapabilities{}), nil, &agentbackend.ModeState{
		Available: []agentbackend.ModeDescriptor{{ID: "code", Name: "Code"}},
	})
	...
	nilModes := newSessionCapabilities(conversation.NewProcessCapabilities(&acp.AgentCapabilities{}), nil, nil)
