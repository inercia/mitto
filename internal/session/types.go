...
type Metadata struct {
	...
	NameExplicit      bool          `json:"name_explicit,omitempty"`    // True when Name was set by an explicit human/MCP rename; permanently suppresses auto-title generation until the name is cleared (mitto-808)
	ACPServer         string        `json:"acp_server"`
