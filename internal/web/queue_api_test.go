...
func TestHandleSessionQueue_Delete_Message(t *testing.T) {
	...
	msg, _ := queue.Add("Test", nil, nil, "", nil, 0)
...
func TestHandleSessionQueue_Clear(t *testing.T) {
	...
	queue.Add("First", nil, nil, "", nil, 0)
	queue.Add("Second", nil, nil, "", nil, 0)
	queue.Add("Third", nil, nil, "", nil, 0)
...
func TestHandleSessionQueue_Get_Message(t *testing.T) {
	...
	msg, _ := queue.Add("Test message", []string{"img1"}, nil, "client1", nil, 0)
...
func TestHandleMoveQueueMessage(t *testing.T) {
	...
	msg1, _ := queue.Add("First message", nil, nil, "", nil, 0)
	msg2, _ := queue.Add("Second message", nil, nil, "", nil, 0)
...
func TestHandleMoveQueueMessage_InvalidDirection(t *testing.T) {
	...
	msg, _ := queue.Add("Test message", nil, nil, "", nil, 0)
