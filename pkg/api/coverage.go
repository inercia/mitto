...
var RouteCoverage = map[string]string{
	...
	"PATCH /api/slack/apps/{appId}":                                "RenameSlackApp",
	"DELETE /api/slack/apps/{appId}":                               "DeleteSlackApp",
	"POST /api/slack/apps/{appId}/validate":                        "ValidateSlackApp",
	"PUT /api/slack/apps/{appId}/token":                            "ReplaceSlackAppToken",
	"PUT /api/slack/apps/{appId}/oauth-client":                     "ConfigureSlackOAuthClient",
	"POST /api/slack/apps/{appId}/oauth/start":                     "StartSlackOAuthInstallation",
	"GET /api/slack/apps/{appId}/prepare-delete":                   "PrepareDeleteSlackApp",
	"DELETE /api/slack/apps/{appId}/references":                    "RemoveSlackAppReferences",
	"GET /api/slack/apps/{appId}/installations":                    "ListSlackInstallations",
	"POST /api/slack/apps/{appId}/installations":                   "CreateSlackInstallation",
	"GET /api/slack/installations/{installationId}":                "GetSlackInstallation",
	"PATCH /api/slack/installations/{installationId}":              "RenameSlackInstallation",
	"DELETE /api/slack/installations/{installationId}":             "DeleteSlackInstallation",
	"POST /api/slack/installations/{installationId}/validate":      "ValidateSlackInstallation",
	"PUT /api/slack/installations/{installationId}/token":          "ReplaceSlackInstallationToken",
	"POST /api/slack/installations/{installationId}/oauth/start":   "StartSlackOAuthReplacement",
	"GET /api/slack/installations/{installationId}/prepare-delete": "PrepareDeleteSlackInstallation",
	"DELETE /api/slack/installations/{installationId}/references":  "RemoveSlackInstallationReferences",
	"GET /api/slack/installations/{installationId}/channels":       "ListSlackChannels",
	"GET /api/slack/oauth/config":                                  "GetSlackOAuthConfig",
	"GET /api/slack/oauth/flows/{flowId}":                          "GetSlackOAuthFlowStatus",
}
