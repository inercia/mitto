...
- [Conversations](config/conversations.md) - Auto-approve, auto-archive, external images
- [Processors](config/processors.md) - Message transformation (text, command, prompt modes)
