...
Present the filtered tickets using `mitto_ui_options_combo_mitto(self_id: "@mitto:session_id")`, showing each ticket as `KEY - Summary` in the dropdown. Ask: "Which in-progress ticket would you like to check status for?"
