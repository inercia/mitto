  ...
  return html`
    <div class="flex gap-2 items-center">
      <select
        ...
        class="px-3 py-2 bg-mitto-surface-3 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-mitto-accent-500"
      ...
      <input
        ...
        disabled=${!matchMode}
        class="flex-1 px-3 py-2 bg-mitto-surface-3 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-mitto-accent-500 ${!matchMode ? "opacity-50 cursor-not-allowed" : ""}"
      />
    </div>
  `;
}
