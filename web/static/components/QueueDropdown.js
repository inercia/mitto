...
export function QueueDropdown({
  ...
  return html`
    <div
      ref=${dropdownRef}
      class="queue-dropdown absolute top-full left-0 right-0 mx-auto mt-1 w-[70%] bg-slate-700/95 backdrop-blur-sm border border-slate-600 rounded-lg z-40 overflow-hidden"
