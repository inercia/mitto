...
describe('API Utilities', () => {
    ...
    describe('apiUrl', () => {
        ...
        test('handles complex paths', () => {
            window.mittoApiPrefix = '/mitto';
            expect(apiUrl('/api/sessions/123/events?limit=50')).toBe('/mitto/api/sessions/123/events?limit=50');
        });
    ...
    describe('wsUrl', () => {
        ...
        test('handles session-specific WebSocket paths', () => {
            ...
            expect(wsUrl('/api/sessions/20260130-165958-ff8d5eb5/ws'))
                .toBe('wss://satie.boreal-vega.ts.net/mitto/api/sessions/20260130-165958-ff8d5eb5/ws');
        });
